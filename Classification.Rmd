...
#l1
t(y_bars[[1]]) %*% solve(pooled_covar) %*% t(as.matrix(table_8_3[1, -1])) - 
  1/2 * t(y_bars[[1]]) %*% solve(pooled_covar) %*% y_bars[[1]]

#l2
t(y_bars[[2]]) %*% solve(pooled_covar) %*% t(as.matrix(table_8_3[1, -1])) - 
  1/2 * t(y_bars[[2]]) %*% solve(pooled_covar) %*% y_bars[[2]]

#l3
t(y_bars[[3]]) %*% solve(pooled_covar) %*% t(as.matrix(table_8_3[1, -1])) - 
